...
// use the cards array to generate html for each card div
function populateCards() {
    document.querySelector('.cards')
    for (let i = 0; i < cards.length; i++) {
        document.querySelector('.cards').innerHTML = document.querySelector('.cards').innerHTML +  '<div onclick="toggleEliminated(this)" class="card"><img src="images/' + cards[i].image + '" /> <span>' + cards[i].name + '</span></div>'
    }
}
